  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      >
        ...
        {/* Indicador de não suportado */}
        {!isSupported && (
          <span className="absolute -bottom-1 -right-1 w-3 h-3 bg-gray-500 rounded-full" title="Notificações não suportadas neste dispositivo" />
        )}
      </button>
