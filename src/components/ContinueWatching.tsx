...
const ContinueWatching: React.FC<ContinueWatchingProps> = ({ items, onRemove }) => {
  ...
  return (
    <div className="px-4 md:px-8 mb-6">
      ...
      <div className="grid grid-cols-3 md:grid-cols-5 gap-[6px] overflow-x-auto pb-4 scrollbar-hide">
        {displayItems.map((item) => (
          <div
            key={item.id}
            className="flex-shrink-0 w-[calc(33.333%-4px)] md:w-full group cursor-pointer"
