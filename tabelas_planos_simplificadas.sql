-- =====================================================
-- TABELAS DE PLANOS - CINECASA (SIMPLIFICADAS)
-- =====================================================
...
-- 3. Estatísticas de planos contratados
SELECT 
    p.nome,
...
-- 4. Atualizar preço do plano BÁSICO
UPDATE planos SET preco = 7.99 WHERE nome = 'BÁSICO';

-- 5. Adicionar novo recurso ao plano PRO
UPDATE planos 
SET recursos = '[
    "Todos os Filmes e Séries",
    "Lançamentos 2025 e 2026", 
...
-- =====================================================
-- FIM DO SCRIPT - TABELAS SIMPLIFICADAS PRONTAS
-- =====================================================
