...
declare namespace Events {
    ...
    let PLAYBACK_PIP_ENTER: string;
    let PLAYBACK_PIP_EXIT: string;
    ...
    let PLAYBACK_FRAGMENT_BUFFERED: string;
    ...
    let CONTAINER_PIP_ENTER: string;
    let CONTAINER_PIP_EXIT: string;
    ...
    let CONTAINER_OPTIONS_WILL_CHANGE: string;
